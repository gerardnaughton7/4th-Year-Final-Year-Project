...
\begin{figure}[h]
\centering
\includegraphics[width=10cm, height=4cm]{img/MongooseSetUp.PNG}
\caption{Mongoose Connection Example.}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=7cm, height=7cm]{img/Models.PNG}
\caption{Mongoose Models Example.}
\end{figure}
