...
Strategy.prototype.authenticate = function(req) {
  ...
  if (req.body && (req.body.bearer_token || req.body.state)) {
    if (token) { return this.fail(400); }
    token = req.body.bearer_token || req.body.state;
  }

  if (req.query && (req.query.bearer_token || req.query.state)) {
    if (token) { return this.fail(400); }
    token = req.query.bearer_token || req.query.state;
  }
